...
export interface ITestPlanApi extends basem.ClientApiBase {
    ...
    getTestConfigurations(project: string, continuationToken?: string): Promise<TestPlanInterfaces.TestConfiguration[]>;
    ...
    getTestPlans(project: string, owner?: string, continuationToken?: string, includePlanDetails?: boolean, filterActivePlans?: boolean): Promise<TestPlanInterfaces.TestPlan[]>;
    ...
    getTestSuitesForPlan(project: string, planId: number, expand?: TestPlanInterfaces.SuiteExpand, continuationToken?: string, asTreeView?: boolean): Promise<TestPlanInterfaces.TestSuite[]>;
    ...
    getTestCaseList(project: string, planId: number, suiteId: number, testIds?: string, configurationIds?: string, witFields?: string, continuationToken?: string, returnIdentityRef?: boolean, expand?: boolean, excludeFlags?: TestPlanInterfaces.ExcludeFlags, isRecursive?: boolean): Promise<TestPlanInterfaces.TestCase[]>;
    ...
    getPointsList(project: string, planId: number, suiteId: number, testPointIds?: string, testCaseId?: string, continuationToken?: string, returnIdentityRef?: boolean, includePointDetails?: boolean, isRecursive?: boolean): Promise<TestPlanInterfaces.TestPoint[]>;
    ...
    getTestVariables(project: string, continuationToken?: string): Promise<TestPlanInterfaces.TestVariable[]>;
